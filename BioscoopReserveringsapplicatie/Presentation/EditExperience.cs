namespace BioscoopReserveringsapplicatie
{
    static class EditExperience
    {
        ...
        public static void Start(int experienceId)
        {
            ...
            SelectionMenu.Create(saveOptions, () => Print(newName, selectedMovieId, newIntensity, timeInInt));
        }
        ...
        public static void Print(string newName, int selectedMovieTitle, string newIntensity, int timeInInt)
        {
