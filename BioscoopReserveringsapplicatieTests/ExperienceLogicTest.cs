namespace BioscoopReserveringsapplicatieTests
{
    ...
    public class ExperienceTest
    {
        ...
        {
            ExperiencesModel experience = new ExperiencesModel("", 0, "", 0, false);
            Assert.IsFalse(_experiencesLogic.ValidateExperience(experience));
            ExperiencesModel experience2 = new ExperiencesModel(null, 0, "", 0, false);
        ...
        {
            ExperiencesModel experience = new ExperiencesModel("test1", 0, "", 0, false);
            Assert.IsFalse(_experiencesLogic.ValidateExperience(experience));
            ExperiencesModel experience2 = new ExperiencesModel("test1", 0, "", 11, false);
            Assert.IsFalse(_experiencesLogic.ValidateExperience(experience2));
        }
        ...
        {
            ExperiencesModel experience = new ExperiencesModel("test1", 0, "", -10, false);
            Assert.IsFalse(_experiencesLogic.ValidateExperience(experience));
        }
        ...
        {
            ExperiencesModel experience = new ExperiencesModel("test1", 0, "laag", 10, false);
